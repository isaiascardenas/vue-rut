...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueRut = __webpack_require__(1);

	var _vueRut2 = _interopRequireDefault(_vueRut);
	...
	describe("vue-rut format test", function () {

	  var vm = void 0;

	  beforeEach(function () {
	    _vue2.default.use(_vueRut2.default);
	  ...
	  it('should make input display an empty string if model value is empty', function () {
	    // vm.rut = '187501776';
	    // vm.$mount();
	    vm.$el.querySelector('#app').value = '187501776';
	    console.log();
	    // console.log(vm.rut);

	    expect(vm.rut).toEqual('18.750.177-6');
	  });
	...
	describe('vue-rut filter test', function () {
	  ...
	  it("filter in a document", function () {
			...
			/***/function (module, exports) {
				...
				var rutDirective = exports.rutDirective = {
					...
					bind: function bind(el, binding, vnode) {
						...
						// this.set(this.vueModel, vnode.context[field]);

						vm.vueModel = vnode.context[field];
					},

					update: function update(el, binding, vnode) {
						var vm = vnode.context;

						vm.inputValue = vnode.elm.value;
						vm.inputValue = formatRut(cleanRut(vm.inputValue));
						el.value = vm.inputValue;

						if (validateRut(inputValue)) {
							vm.vueModel = vm.inputValue;
						} else {
							vm.vueModel = null;
						}
					},
